...
func (r *mutationResolver) SetPanTiltOffset(ctx context.Context, newOffset float64) (bool, error) {
	err := r.Dependency.Invoke(func(deps *pan_tilt.PanTiltDependency) error {
		if deps.IsBusy {
			return errors.New("Pan-Tilt is busy")
		}
...
// GetTLEIdsByKeyword is the resolver for the getTLEIdsByKeyword field.
func (r *queryResolver) GetTLEIdsByKeyword(ctx context.Context, keyword string) ([]*int64, error) {
	panic(fmt.Errorf("not implemented: GetTLEIdsByKeyword - getTLEIdsByKeyword"))
}
